"""
ONLY NEEDED TO RUN ONCE, SINCE THE LANES ARE A FUNDAMENTAL PART OF THE GAME AND WILL NEVER CHANGE. THIS SCRIPT WAS RUN ONLY ONCE TO HELP SETUP AND SCRAPE AND DOESNT NEED TO BE RUN AGAIN, BUT I WILL KEEP IT HERE SO I KNOW HOW I SCAPED IT.
"""
